...
const App = () => {
    ...
    useEffect(() => {
        ...
        drawScene(gl, programInfo, buffers, currentModel.positions.length / 3, rotationAngle);
    }, []);
    ...
    const handleX = (angle) => {
        ...
        drawScene(glAttr.gl, glAttr.programInfo, glAttr.buffers, currentModel.positions.length / 3, rotationAngle);
    };
